...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Section.fallback_image'
        db.add_column('content_section', 'fallback_image', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Section.fallback_image'
        db.delete_column('content_section', 'fallback_image')
