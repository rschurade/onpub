...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('content_section', 'order')


    def backwards(self, orm):
        
        # Adding field 'Section.order'
        db.add_column('content_section', 'order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True), keep_default=False)
