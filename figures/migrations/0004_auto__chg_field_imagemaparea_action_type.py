...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImageMapArea.action_type'
        db.alter_column('figures_imagemaparea', 'action_type', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'ImageMapArea.action_type'
        db.alter_column('figures_imagemaparea', 'action_type', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=None))
    ...
    models = {
        ...
        'figures.imagemaparea': {
            ...
            'action_type': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
